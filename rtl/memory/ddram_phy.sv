...
//
// Copied unchanged from Arcade-Seta_MiSTer, which vendored it from Arcade-Fuuki_MiSTer (562c3de), which took it from
// Arcade-Psikyo_MiSTer, where the protocol was verified against a working
// reference (MiSTer-devel/TSConf_MiSTer's ddram.sv) rather than derived from
// the documentation alone. Unchanged except for this header.
//
